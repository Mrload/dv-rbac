...
@router.get("/", response_model=PaginatedResult[schemas.PermissionRead], summary="获取权限列表", description="获取权限列表",name="permission:list")
...
@router.post("/", response_model=schemas.PermissionRead, summary="创建新权限", description="创建新权限",name="permission:create")
...
@router.get("/{permission_id}", response_model=schemas.PermissionRead, summary="根据ID获取权限", description="根据ID获取权限",name="permission:retrieve")
...
@router.put("/{permission_id}", response_model=schemas.PermissionRead, summary="更新权限信息", description="更新权限信息",name="permission:update")
...
@router.delete("/{permission_id}", summary="删除权限", description="删除权限", status_code=204,name="permission:delete")
